...
import com.example.fitness.security.jwt.AuthEntryPointJwt;
import com.example.fitness.security.jwt.AuthTokenFilter;
import com.example.fitness.service.UserDetailsServiceImpl;
...
//  }
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
        ...
        .requestMatchers("/trainingProgram/**").permitAll()
